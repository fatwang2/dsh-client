 ...
 *
 * The Host process owns application lifetime: an ordinary window close only
 * hides the window, Dock activation restores it, and an explicit quit disposes
 * the Host before releasing Electron's quit sequence.
 */
